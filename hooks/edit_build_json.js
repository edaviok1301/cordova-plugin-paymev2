...
if( !obj_ios_debug.buildFlag.includes('EMBEDDED_CONTENT_CONTAINS_SWIFT = YES') ) {
    obj_ios_debug.buildFlag.push( 'EMBEDDED_CONTENT_CONTAINS_SWIFT = YES' );
    }
    if( !obj_ios_release.buildFlag.includes('EMBEDDED_CONTENT_CONTAINS_SWIFT = YES') ) {
    obj_ios_release.buildFlag.push( 'EMBEDDED_CONTENT_CONTAINS_SWIFT = YES' );
    }
